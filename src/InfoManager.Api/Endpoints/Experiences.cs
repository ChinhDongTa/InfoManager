...
public class Experiences : EndpointGroupBase
{
    ...
    public async Task<IResult> GetExperienceByIdAsync(string id, [FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken)
    {
    ...
    /// <response code="500">If an internal server error occurs.</response>
    public async Task<IResult> GetExperiencesAsync([FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken, int pageNumber = 1, int pageSize = 20)
    {
    ...
    /// <response code="404">If the experience is not found.</response>
    /// <response code="500">If an internal server error occurs.</response>
    public async Task<IResult> CreateExperienceAsync([FromBody] CreateExperienceCommand command, [FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken)
    {
    ...
    /// <response code="404">If the experience is not found.</response>
    /// <response code="500">If an internal server error occurs.</response>
    public async Task<IResult> UpdateExperienceAsync(string id, [FromBody] UpdateExperienceCommand command, [FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken)
    {
        if (id != command.Id)
        {
    ...
    /// <response code="404">If the experience is not found.</response>
    /// <response code="500">If an internal server error occurs.</response>
    public async Task<IResult> DeleteExperienceAsync(string id, [FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken)
    {
