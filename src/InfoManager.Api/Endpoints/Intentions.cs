...
public class Intentions : EndpointGroupBase
{
    ...
    public async Task<IResult> GetIntentionsAsync([FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken, int pageNumber = 1, int pageSize = 20)
    {
    ...
    /// <response code="401">If the user is not authorized.</response>
    /// <response code="500">If an internal server error occurs.</response> 
    public async Task<IResult> GetTopIntentionsAsync(int top, [FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken)
    {
    ...
    /// <response code="401">If the user is not authorized.</response>
    /// <response code="500">If an internal server error occurs.</response>
    public async Task<IResult> SearchIntentionsAsync(
        [AsParameters] SearchIntentionRequest request,
    ...
    /// <response code="500">If an internal server error occurs.</response>
    public async Task<IResult> GetIntentionByIdAsync(string id, [FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken)
    {
    ...
    /// <response code="401">If the user is not authorized.</response>
    /// <response code="500">If an internal server error occurs.</response> 
    public async Task<IResult> CreateIntentionAsync([FromBody] CreateIntentionCommand command, [FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken)
    {
    ...
    /// <response code="404">If the intention is not found.</response>
    /// <response code="500">If an internal server error occurs.</response>
    public async Task<IResult> UpdateIntentionAsync(string id, [FromBody] UpdateIntentionCommand command, [FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken)
    {
        if (id != command.Id)
        {
    ...
    /// <response code="404">If the intention is not found.</response>
    /// <response code="500">If an internal server error occurs.</response>
    public async Task<IResult> DeleteIntentionAsync(string id, [FromServices] ISender sender, [FromServices] IUser user, CancellationToken cancellationToken)
    {
