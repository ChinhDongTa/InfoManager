...
{
    public async Task<Result<PaginatedList<FarmFinancialSummarySummaryDto>>> Handle(SearchFarmFinancialSummariesQuery request, CancellationToken cancellationToken)
    {
