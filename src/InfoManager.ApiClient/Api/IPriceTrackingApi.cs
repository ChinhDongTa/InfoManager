...
public interface IPriceTrackingApi
{
    ...
    Task<ApiResponse<MessageResponse>> UpdatePriceTrackingAsync(string id, [Body] UpdatePriceTrackingRequest request, CancellationToken ct);
