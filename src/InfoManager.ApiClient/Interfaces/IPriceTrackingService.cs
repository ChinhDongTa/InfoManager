...
public interface IPriceTrackingService
{
    ...
    Task<ApiResult> UpdatePriceTrackingAsync(string id, UpdatePriceTrackingRequest request, CancellationToken ct = default);
    Task<ApiResult> DeletePriceTrackingAsync(string id, CancellationToken ct = default);
